...
class TrackedCollection<K>(
    val original: MutableCollection<K>,
    val onAdd: Function<K, Boolean>,
    val onRemove: Function<K, Boolean>,
) : MutableCollection<K> by original {
    ...
    override fun iterator() = TrackedCollectionIterator(original.iterator(), onRemove)
...
class TrackedCollectionIterator<K>(
