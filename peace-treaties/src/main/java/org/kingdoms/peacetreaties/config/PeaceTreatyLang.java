...
public enum PeaceTreatyLang implements DefinedMessenger {
    ...
    TERMS_MISC_UPGRADES_MESSAGE("{$e}Your will not be able to disable/enable misc upgrades and the proposer kingdom will have full control of them.", 1, 3),
    TERMS_KEEP_LANDS_MESSAGE("{$p}The following lands will be given back to your kingdom{$sep}:\n%term_keep_lands_returning_lands%", 1, 3),
    TERMS_SCUTAGE_MESSAGE("{$e}Your kingdom has to pay {$es}%term_scutage_percent%% {$e}of their bank money as taxes.", 1, 2),
