...
public enum PeaceTreatyLang implements DefinedMessenger {
    ...
    WAR_POINTS_GAIN_INVADE("{$p}Your kingdom has gained {$s}%war_points% {$p}for the invasion.", 2, 3),
    WAR_POINTS_GAIN_KILL("{$p}Your kingdom has gained {$s}%war_points% {$p}for killing {$s}%other_player% {$p}by {$s}%player%", 2, 3),
    WAR_POINTS_GAIN_BREAK_TURRET("{$p}Your kingdom has gained {$s}%war_points% {$p}for breaking {$es}%kingdoms_kingdom_name%'s %style% {$e}turret.", 2, 3),
    WAR_POINTS_GAIN_BREAK_STRUCTURE("{$p}Your kingdom has gained {$s}%war_points% {$p}for breaking {$es}%kingdoms_kingdom_name%'s %style% {$e}structure.", 2, 3),
    WAR_POINTS_LOST_INVADE("{$e}Your kingdom has lost {$es}%war_points% {$e}for losing the invasion.", 2, 3),
    WAR_POINTS_LOST_KILL("{$e}Your kingdom has lost {$es}%war_points% {$p}for death of {$es}%other_player% {$e}by {$es}%player%", 2, 3),
    WAR_POINTS_LOST_BREAK_TURRET("{$e}Your kingdom has lost {$es}%war_points% {$e}because {$es}%kingdoms_kingdom_name% {$e}broke your {$es}%style% {$e}turret.", 2, 3),
    WAR_POINTS_LOST_BREAK_STRUCTURE("{$e}Your kingdom has lost {$es}%war_points% {$e}because {$es}%kingdoms_kingdom_name% {$e}broke your {$es}%style% {$e}structure.", 2, 3),
